...
function Footer() {
  return (
    <>
      <div className="bg-gray-900 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          ...
          <ul className="flex flex-wrap items-center space-x-4">
            <li>
              <a
                href="/"
                className="text-sm font-medium text-gray-400 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                Privacy Policy
              </a>
            </li>
